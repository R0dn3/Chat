...
public class SedeMollendo extends javax.swing.JFrame {
    ...
    private void iniciarServidor() {
        try {
            serverSocket = new ServerSocket(5000); // Puerto de Sede Mollendo
            new Thread(() -> {
                while (true) {
                    try {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(nombreUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void enviarMensajeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarMensajeActionPerformed
        ...
        try {
            ...
            if (!usuario.isEmpty() && !mensaje.isEmpty()) {
                ...
                Socket socket = new Socket("localhost", 6000); // Puerto de Sede Camana
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SedeMollendo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SedeMollendo().setVisible(true);
            }
        });
    }
